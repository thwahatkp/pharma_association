...
$domestics = $app['database']->GetDomesticProducts();
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active-nav nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item nav-active" href="./domestic.php">Domestic LPG</a>
                                    </div>
                                </li>
                                </li>
                                <li class="has-mega-menu homedemo">
            ...
            <div class="dlab-bnr-inr overlay-black-middle bg-pt" style="background-image: url(./img/banner/gas.jpg)">
                <div class="container">
                    <div class="dlab-bnr-inr-entry">
                        <h1 class="text-white">Domestic LPG</h1>
                    ...
                    <div class="section-content">
                        <div class="row d-flex">
                            <div class="col-lg-6 col-md-12 m-b30">
                                <div class="video-bx">
                                    <img src="./img/domestic/d1.jpg" alt="Signature">

                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 m-b30 align-self-center video-infobx">
                                <div class="content-bx1">
                                    <h2 class="m-b15 title">Good food, good memories<br><span class="text-primary"> New LPG Connection for Home</span></h2>
                                    <p class="m-b30">We are offering Domestic LPG Cylinders to our clients.
                                        This product is checked on several parameters by our quality experts to ensure a
                                        defect free range before delivering it to the clients.
                                        Offered range of Domestic LPG Cylinders can be availed at market-leading prices.<br>
                                        Now get new LPG connection with Malabar gas without time and hassle. This process requires minimal
                                        paperwork and ensures fast and timely delivery within 24 hours.</p>
            ...
            <div class="section-full content-inner-2 bg-white wow fadeIn" style="background-image:url(images/background/map-bg1.png)" data-wow-duration="2s" data-wow-delay="0.6s">
                <div class="container">
                    <div class="section-head style2 text-center">
                        <h2 class="title">Available Domestic Products</h2>
                            ...
                            <div class="item">
                                <div class="testimonial-12 text-white">
                                    <div class="testimonial-pic">
                                        <img style="width: 100%;height:auto;" src="<?php echo 'admin/' . $domestic->img_path ?>" alt="">
                                    </div>
                                    <div class="testimonial-detail">
                                        <h4 class="testimonial-name m-t0 m-b5"><?php echo $domestic->title ?></h4>
                                        <span class="testimonial-position"><?php echo $domestic->kg ?> Kg</span>
                    ...
                    <div class="col-xl-6 col-lg-12 p-lr0 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.3s">
                        <div class="row spno">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <img class="img-cover" src="./img/compress/6.jpg" alt="">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="video-bx radius-no h100">
                                    <img src="./img/about/about4.jpg" alt="Signature" class="img-cover">
