          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <a class="btn btn-success add-btn" href="./add-careers.php">Add Career</a>
                
                <table id="careers-tbl" class="table table-striped table-bordered mb-0" cellspacing="0" width="100%">
                  <thead>
                  <tr>
                      <th></th>
                      <th>Title</th>
