          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <a class="btn btn-success add-btn" href="edit-testimonials.php">Add Testimonial</a>
                <!-- Table with stripped rows -->
                <table id="testimonials-tbl" class="table table-striped table-bordered mb-0" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th></th>
                      <th>Name</th>
