...
?>
  ...
  <body>
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <a class="btn btn-success add-btn" href="edit-franchisees.php">Add Franchisee</a>
                
                <table id="franchisees-tbl" class="table table-striped table-bordered mb-0" cellspacing="0" width="100%">
                  <thead>
                  <tr>
                      <th></th>
                      <th>Name</th>                    
    ...
    <script src="assets/js/franchisees.js"></script>
