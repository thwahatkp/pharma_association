                        ...
                        <div class="col-lg-6 col-md-12 bg-primary">
                            <div class="max-w700 m-auto p-tb50 p-lr20">
                                <div class="text-white">
                                    ...
                                    <h2> Malabar Gas provide Light Safe Composite L.P.G Cylinders</h2>
                                </div>
                                <div class="icon-bx-wraper m-b10 left">

                                    <div class="icon-content">

                                        <p>Kerala's first private L. P. G Bottling Plant</p>
                                    </div>
                                </div>
                                <div class="icon-bx-wraper m-b10 left">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>Life safe composite LPG cylinders for the first time in Kerala by Malabar Gas</p>
                                    </div>
                                </div>
                                <div class="icon-bx-wraper m-b10 left">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p> Light weight unlike current metal cylinders</p>
                                    </div>
                                </div>
                                <div class="icon-bx-wraper m-b10 left">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>No corrosion or leakage due to it</p>
                                    </div>
                                </div>
                                <div class="icon-bx-wraper m-b10 left">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>Check the gas level in the cylinder from outside and therefore refill.
                                            You can also know the time to do it.</p>
                                    </div>
                                </div>
