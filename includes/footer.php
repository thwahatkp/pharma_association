          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xl-4 col-lg-3 col-sm-6 footer-col-4">
              <div class="widget widget_getintuch">
                ...
                <ul>
                  <li>
                    <i class="ti-location-pin"></i><strong>address</strong>Chamber Of Pharma Entrepreneurs,
                    Chembaka Housing Colony, Olive Building
                    Chalappuram,
                    Calicut,Kerala
                  </li>
                  <li>
                    <i class="ti-mobile"></i><strong>phone</strong>+91 9544101177

                  </li>
                  <li>
                    <i class="ti-email"></i><strong>email</strong>copekerala@gmail.com
                  </li>
                </ul>
              </div>
            </div>
